 ...
 */
export var AssetFemale3DCGExtended: ExtendedItemMainConfig & Partial<Record<"Decals" | "TailStraps" | "ClothOuter" | "EyeShadow", ExtendedItemGroupConfig>> = {
	BodyUpper: {
			...
			Modules: [
				...
				},
				{
					...
					Options: [
						...
						{
							// r1 - Mermaid Type
							Property: { Effect: [E.MapSwim as EffectName] },
						},
					],
				},
				{
			...
			Modules: [
				{
					...
					Options: [
						{}, // l0 - Full size
						{}, // l1 - Mid legs
						{ Effect: [E.MapSwim as EffectName] }, // l2 - Full size plus mermaid end
					],
				},
				{
					Name: "Position",
									...
									AfterDraw: (...args) =>
										TextItem.GenericTextArcDrawHook(...args, {
											...
											drawOptions: {
												fontSize: 20,
												radius: 60,
												effect: "burn" as DynamicDrawTextEffect,
											},
										}),
								},
							},
